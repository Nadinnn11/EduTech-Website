...
<div class="container mt-5 pt-5">
    <div class="row justify-content-between mb-4">
        ...
        <div class="col-md-6 text-end">
            <a href="{{ route('courses.create') }}" class="btn btn-primary btn-lg">+ Tambah Kursus</a>
        </div>
    </div>
    ...
    <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow">
                    <div class="card-body">
                        ...
                        <p class="card-text">{!! Str::limit(nl2br($course->description), 100) !!}</p>
        ...
        @empty
            <div class="col-12 text-center py-5">
                ...
                <a href="{{ route('courses.create') }}" class="btn btn-primary btn-lg">Buat kursus pertama</a>
            </div>
        @endforelse
    </div>
